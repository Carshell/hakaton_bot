...
FEEDBACK_PROMPT = (
    "Напиши одне повідомлення — ми перешлемо його адміну.\n"
    "Після відправки можна знову користуватися ботом як звичайно.\n"
    "Адмін відповість у цей чат."
)

FEEDBACK_SENT = (
    "Повідомлення надіслано адміну! Очікуй відповіді.\n"
    "Можеш далі користуватися ботом — /menu або /start."
)
